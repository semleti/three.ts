...
let ColorKeywords = { 'aliceblue': 0xF0F8FF, 'antiquewhite': 0xFAEBD7, 'aqua': 0x00FFFF, 'aquamarine': 0x7FFFD4, 'azure': 0xF0FFFF,
...
export class Color {
	...
	constructor( r? : number | Color | string, g? : number, b? : number ){
		...
		return this.setRGB( r as number, g, b );
	...
	//TODO: create class
	getHSL ( optionalTarget? : Color.hsl ) : Color.hsl {

		// h,s,l ranges are in 0.0 - 1.0

		let hsl = optionalTarget ||  new Color.hsl;
