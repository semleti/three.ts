...
export class Interpolant {
	...
	parameterPositions;_cachedIndex;resultBuffer;sampleValues;valueSize;
				...
				linear_scan: {
					...
					if ( ! ( t >= t0 ) ) {
						...
						for ( let giveUpAtt = i1 - 2; ; ) {
							...
							if ( i1 === giveUpAtt ) break; // this loop
	...
	copySampleValue_ ( index : number, a? : any, b? : any ) : any {
