...
export class AnimationObjectGroup {
	uuid : string;
	_objects : Array<AnimationClip>;
	nCachedObjects_ : number;
	_indicesByUUID : Array<number>;
	_paths : Array<string> = [];					// inside: string
	_parsedPaths : Array<PropertyBinding.ParsedPath> = [];				// inside: { we don't care, here }
	_bindings : Array<Array<PropertyBinding>> = []; 				// inside: Array< PropertyBinding >
	//TODO: check if not {} as originally
	_bindingsIndicesByPath : Array<number> = []; 	// inside: indices in these arrays
	//TODO: create class
	...
	isAnimationObjectGroup : boolean = true;
	...
	subscribe_ ( path : string, parsedPath : PropertyBinding.ParsedPath ) : Array<PropertyBinding> {
		...
		let paths = this._paths,
			...
			nObjects = objects.length,
			nCachedObjects = this.nCachedObjects_,
			bindingsForPath = new Array<PropertyBinding>( nObjects );
