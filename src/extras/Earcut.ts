...
function linkedList( data : any, start : number, end : number, dim : number, clockwise : boolean ) : Node {
...
function earcutLinked( ear : Node, triangles : Array<number>, dim : number, minX : number, minY : number, invSize : number, pass? : number ) : void {
...
function cureLocalIntersections( start : Node, triangles : Array<number>, dim : number ) : Node {
...
function splitEarcut( start : Node, triangles : Array<number>, dim : number, minX : number, minY : number, invSize : number ) : void {
...
function eliminateHoles( data : any, holeIndices : Array<number>, outerNode : Node, dim : number ) : Node {
...
function equals( p1 : Vector2, p2 : Vector2 ) : boolean {
...
function intersects( p1 : Vector2, q1 : Vector2, p2 : Vector2, q2 : Vector2 ) : boolean {
...
export class Node extends Vector2{
...
function signedArea( data : any, start : number, end : number, dim : number ) : number {
