...
let tmp = new Vector3();
let px = new CubicPoly(), py = new CubicPoly(), pz = new CubicPoly();

export class CatmullRomCurve3 extends Curve {
	type : string = 'CatmullRomCurve3';
	...
	toJSON () : CatmullRomCurve3.Data {

		let data = super.toJSON() as CatmullRomCurve3.Data;
	...
	fromJSON ( json : CatmullRomCurve3.Data ) : CatmullRomCurve3 {
...
export module CatmullRomCurve3{
