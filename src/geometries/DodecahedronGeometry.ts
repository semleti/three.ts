...
export class DodecahedronGeometry extends Geometry {
	type : string = 'DodecahedronGeometry';
...
export class DodecahedronBufferGeometry extends PolyhedronBufferGeometry {
	...
	static r : number = 1 / DodecahedronBufferGeometry.t;
	...
	type : string = 'DodecahedronBufferGeometry';
	constructor( radius : number, detail : number ){
		super(DodecahedronBufferGeometry.vertices, DodecahedronBufferGeometry.indices, radius, detail );
		this.parameters = {
			radius: radius,
			detail: detail
		};
